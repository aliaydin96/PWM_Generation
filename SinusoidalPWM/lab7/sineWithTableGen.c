...
////////////////////////////////////////////////////////////////////////////////////////////   //
 ...
 int arrayA[1600];           //this array is created for graph visulization
                         // number inside the array = switchingFrequency / fundamentalSinusoidalFrequency
// int arrayB[1600];           // N is the same with array number
 float sineTable[800];
 ///////////////////////////////////////////////////////////////////////////////////////////   //
                                                                                               //
 ////////////////////////////////////////////////////////////////////////////////////////////////
...
void main(void)
{
        ...
        counter2 = 2 * frequencyModulationRatio / 3;
        counter3 = frequencyModulationRatio / 3;
...
interrupt void ePWMA_compare_isr(void) {
  ...
  //  GpioDataRegs.GPASET.bit.GPIO10 = 1;
    ...
    sinus = (sineTable[counter1] + 1) / 2;
    sinus2 = (sineTable[counter2] + 1) / 2;
    sinus3 = (sineTable[counter3] + 1) / 2;
    ...
    counter1 +=1;
    if( counter1 > ((1 / frequencyModulationRatio)-1)) counter1 = 0;
    counter2 +=1;
...
*/
    ...
    if (i < 2*frequencyModulationRatio ) {
        arrayA[i] = cmp_phaseB;//(AphaseVoltage - 1.5) / 8.2 / 2 / (4 * 10^6);
 //       arrayB[i] = cmp_phaseB;
        i = i + 1;
    }
    else {
...
void SineTableGenerator(void){
    frequencyModulationRatio = fundamentalSinusoidalFrequency / switchingFrequency;
    int i = 0;
    for(i; i < frequencyModulationRatio; i = i+1){
        sineTable[i] = sin(2 * PI * (frequencyModulationRatio) * i + phaseAngle);
    }
}
//===========================================================================
// End of SourceCode.
