...
//////////////////////////////////////////////////////////////////////////////////////////
        ...
        AdcRegs.ADCMAXCONV.all = 0x0006; // 4 conversions
...
interrupt void adc_isr(void){
    ...
    fundamentalSinusoidalMagnitude = voltage_vr1 * 3.3/4095;

    voltage_vr2 = AdcMirror.ADCRESULT1;
    fundamentalSinusoidalFrequency = voltage_vr2 * 55 / 4095 + 5;
    ...
    int AphaseVoltage = (AdcMirror.ADCRESULT4) * 3.3 / 4095;

    int BphaseVoltage = (AdcMirror.ADCRESULT5) * 3.3 / 4095;

    int CphaseVoltage = (AdcMirror.ADCRESULT6) * 3.3 / 4095;
